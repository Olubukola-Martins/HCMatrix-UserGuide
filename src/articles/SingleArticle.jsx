...
const SingleArticle = () => {
  ...
  return (
    <section className="mt-3 font-SFPro article">
      {!singleArticle && <NoData msg={`No Content found !!!`} />}
      {singleArticle && (
        <header
          className={`flex flex-col items-center ${
            singleArticle?.video ? "" : "mb-3"
        ...
        >
          <div className="order-2 md:order-1 w-full md:w-[60%] md:mr-5">
            ...
            <span className="text-[12px] block mb-3">{`Learn about ${singleArticle?.articleTitle?.toLowerCase()}`}</span>
