...
import { HuggingFace } from "../assets/HeroIcons";
import Idea from "../assets/HeroIcons/idea";
  ...
  return (
    ...
    >
      ...
      <Container style="relative py-10">
        ...
        <div className="w-[100%] md:w-[75%] mx-auto mt-24 md:mt-20 ">
          ...
          <GlassDesign className="rounded-md pl-5 py-2 md:py-4 ">
            <div className="flex">
              <svg
                width="42"
                height="42"
